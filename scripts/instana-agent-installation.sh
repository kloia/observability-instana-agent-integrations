...
INSTANA_AGENT_HOST="${INSTANA_AGENT_HOST:-ingress-blue-saas.instana.io}"
...
while getopts "syjinl:e:t:m:a:d:i:z:g:b:u:p:P:" opt; do
  case $opt in
    a)
      INSTANA_AGENT_KEY=$OPTARG
      ;;
    b)
      INSTANA_AGENT_HOST=$OPTARG
      ;;
    P)
      INSTANA_AGENT_PORT=$OPTARG
      ;;
    d)
